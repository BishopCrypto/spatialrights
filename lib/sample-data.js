...
export const arZones = [
  ...
  // Willis Tower zones
  {
    id: 'willis-north-facade',
    property_id: 'willis-tower-chicago',
    zone_name: 'North Facade Premium',
    zone_type: 'bulletin',
    facade_direction: 'north',
    width_feet: 48.0,
    height_feet: 14.0,
    square_footage: 672,
    base_price_monthly: 220000,
    premium_multiplier: 1.4,
    availability_status: 'available',
    visibility_score: 10,
    traffic_exposure_score: 9,
    description: 'Premium north-facing billboard with maximum Chicago skyline visibility.',
    standard_size: '14\' × 48\' (Bulletin)',
    engagement_rate: 0.08
  },
  {
    id: 'willis-south-facade',
    property_id: 'willis-tower-chicago',
    zone_name: 'South Facade Standard',
    zone_type: 'bulletin',
    facade_direction: 'south',
    ...
    visibility_score: 9,
    traffic_exposure_score: 8,
    description: 'South-facing billboard overlooking downtown Chicago.',
    standard_size: '14\' × 48\' (Bulletin)',
    engagement_rate: 0.075
  },
  {
    id: 'willis-east-facade',
    property_id: 'willis-tower-chicago',
    zone_name: 'East Facade Premium',
    zone_type: 'bulletin',
    facade_direction: 'east',
    width_feet: 48.0,
    height_feet: 14.0,
    square_footage: 672,
    base_price_monthly: 200000,
    premium_multiplier: 1.3,
    availability_status: 'available',
    visibility_score: 9,
    traffic_exposure_score: 9,
    description: 'East-facing billboard with Lake Michigan views and high traffic exposure.',
    standard_size: '14\' × 48\' (Bulletin)',
    engagement_rate: 0.078
  },
  {
    id: 'willis-west-facade',
    property_id: 'willis-tower-chicago',
    zone_name: 'West Facade',
    zone_type: 'bulletin',
    facade_direction: 'west',
    width_feet: 48.0,
    height_feet: 14.0,
    square_footage: 672,
    base_price_monthly: 170000,
    premium_multiplier: 1.1,
    availability_status: 'available',
    visibility_score: 8,
    traffic_exposure_score: 8,
    description: 'West-facing billboard with sunset city views.',
    standard_size: '14\' × 48\' (Bulletin)',
    engagement_rate: 0.07
  },
  {
    id: 'willis-skydeck-entrance',
    property_id: 'willis-tower-chicago',
    zone_name: 'Skydeck Entrance Zone',
    zone_type: 'entrance',
    facade_direction: 'entrance',
    width_feet: 22.0,
    height_feet: 10.0,
    square_footage: 220,
    base_price_monthly: 140000,
    premium_multiplier: 1.7,
    availability_status: 'booked',
    visibility_score: 9,
    traffic_exposure_score: 10,
    description: 'High-impact Skydeck entrance advertising with tourist traffic.',
    standard_size: '10\' × 22\' (Custom)',
    engagement_rate: 0.12,
    current_booking: {
      advertiser: 'United Airlines',
      campaign: 'Fly Chicago',
      end_date: '2025-03-31'
    }
  },
  {
    id: 'willis-lobby-digital',
    property_id: 'willis-tower-chicago',
    zone_name: 'Main Lobby Digital Display',
    zone_type: 'custom',
    facade_direction: 'interior',
    width_feet: 32.0,
    height_feet: 18.0,
    square_footage: 576,
    base_price_monthly: 95000,
    premium_multiplier: 1.2,
    availability_status: 'available',
    visibility_score: 8,
    traffic_exposure_score: 9,
    description: 'Large digital display in main lobby targeting business professionals.',
    standard_size: '18\' × 32\' (Custom Digital)',
